...
class CliRunnerTest {
  ...
  //              final Throwable actualThrowable = actualThrowableOpt.get();
  //              assertThat(actualThrowable).isExactlyInstanceOf(CliException.class);
  //              assertThat(actualThrowable.getMessage()).contains("Missing argument for option:
  // s");
  //            });
  //  }
  //
  ...
  //        "\"published=true AND masterData(masterVariant(attributes(name= \\\"abc\\\" AND
  // value=123)))\"";
  ...
  //        spy(
  //            SyncerFactory.of(
  //                () -> mock(SphereClient.class), () -> mock(SphereClient.class),
  // getMockedClock()));
  //    // test
  ...
  //            format(
  //                "-%s,--%s <arg> %s",
  //                SYNC_MODULE_OPTION_SHORT, SYNC_MODULE_OPTION_LONG,
  // SYNC_MODULE_OPTION_DESCRIPTION))
  //        .contains(
  //            format(
  //                "-%s,--%s <arg> %s",
  //                RUNNER_NAME_OPTION_SHORT, RUNNER_NAME_OPTION_LONG,
  // RUNNER_NAME_OPTION_DESCRIPTION))
  //        .contains(
  //            format(
  //                "-%s,--%s %s",
