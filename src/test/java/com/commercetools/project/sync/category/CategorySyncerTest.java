...
class CategorySyncerTest {
  ...
  //        Collections.singletonList(readObjectFromResource("category-no-key.json",
  // Category.class));
  //
  ...
  //        .isEqualTo(
  //            "CategoryDraft with name: LocalizedString(en -> category-name-1) doesn't have a key.
  ...
  //        Collections.singletonList(readObjectFromResource("category-key-2.json",
  // Category.class));
  ...
  //        .thenReturn(
  //            singleton(new ResourceKeyId("categoryKey2",
  // "ba81a6da-cf83-435b-a89e-2afab579846f")));
