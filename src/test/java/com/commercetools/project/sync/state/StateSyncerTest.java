...
class StateSyncerTest {
    ...
    void transform_ShouldReplaceReferenceIdsWithKeys() {
        ...
        final StateDraftDsl draft1 = StateDraftBuilder.of("State 1", StateType.LINE_ITEM_STATE)
                                                     ...
                                                     .build();
        final StateDraftDsl draft2 = StateDraftBuilder.of("State 2", StateType.LINE_ITEM_STATE)
                                                      .roles(Collections.emptySet())
    ...
    void getQuery_ShouldBuildStateQueryWithTransitionsExpanded() {
        ...
        // assertion
        assertThat(query).isEqualTo(StateQuery.of().withExpansionPaths(StateExpansionModel::transitions));
    }
}
