...
public class InventoryEntrySyncerTest {
    ...
    public void of_ShouldCreateInventoryEntrySyncerInstance() {
        ...
        final InventoryEntryQuery expectedQuery = InventoryEntryQuery
            .of()
    ...
    public void transformResourcesToDrafts_ShouldReplaceInventoryEntryReferenceIdsWithKeys() {
        ...
        // test
        final List<InventoryEntryDraft> draftsFromPage = inventoryEntrySyncer.transformResourcesToDrafts(inventoryPage);

        // assertions
        final List<InventoryEntryDraft> expectedResult = replaceInventoriesReferenceIdsWithKeys
            (inventoryPage);
