...
public class BaseSyncStatisticsDeserializer extends StdDeserializer<BaseSyncStatistics> {
    ...
    public BaseSyncStatistics deserialize(JsonParser jsonParser, DeserializationContext ctxt)
        ...
        // since BaseSyncStatistics is abstract and there's no difference in the Subclasses except implementation of
        // method getReportMessage(), additionally there's no field which could be used to identify the type of the
        // subclass, the jsonNode is mapped to any concrete class
        // this is a workaround, to fix that BaseSyncStatistics in java-sync library needs to be adjusted declaring
