...
public final class CustomObjectSyncer
  ...
  private final boolean syncProjectSyncCustomObjects;
   ...
   * @param syncProjectSyncCustomObjects if true, custom objects generated by the project sync will
   *     be excluded.
   */
  private CustomObjectSyncer(
      ...
      boolean syncProjectSyncCustomObjects) {
    super(sync, sourceClient, targetClient, customObjectService, clock);
    this.runnerName = runnerName;
    this.syncProjectSyncCustomObjects = syncProjectSyncCustomObjects;
  }
  ...
  protected CustomObjectQuery<JsonNode> getQuery() {
    ...
    if (syncProjectSyncCustomObjects) {
